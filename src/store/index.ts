...
import { dighubApi } from '@/api/dighub/v1';
...
const store = configureStore({
  reducer: {
    ...
    [dighubApi.reducerPath]: dighubApi.reducer,
  },
...
export type RootState = {
  ...
  [dighubApi.reducerPath]: ReturnType<typeof dighubApi.reducer>;
};
