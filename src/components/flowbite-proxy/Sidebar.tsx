...
const sidebarTheme = {
  root: {
    ...
    inner: 'h-full overflow-y-auto overflow-x-hidden px-3 py-4 bg-gray-800',
  },
  collapse: {
    button:
  ...
  item: {
    base: 'flex items-center justify-center rounded-sm p-2 text-base font-normal text-gray-300 font-medium text-left capitalize hover:bg-gray-700',
    active: 'bg-gray-700',
    collapsed: {
    ...
    icon: {
      ...
      active: 'text-gray-700 text-gray-100',
    },
    label: '',
    listItem: '',
  },
